#    GLoW Trial Health Economic Analysis using the Sheffield Type 2 Diabetes Treatment Model - version 3
#    Copyright (C) 2023 Pidd, Pollard, Breeze, sb,ct,jm,AA,sg,ab
...
#####set up to run all population of zerobmidec in one run
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationA.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationA.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationA.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
...
GlobalVars["Population Subset", "Value"] <- "B"
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationB.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationB.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationB.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
...
GlobalVars["Population Subset", "Value"] <- "C"
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationC.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationC.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationC.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
...
GlobalVars["Population Subset", "Value"] <- "D"
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationD.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationD.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationD.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
...
################    E
GlobalVars["Population Subset", "Value"] <- "E"
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationE.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationE.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationE.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
...
######################    F
GlobalVars["Population Subset", "Value"] <- "F"
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationF.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationF.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationF.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
...
GlobalVars["Population Subset", "Value"] <- "G"
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationG.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationG.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationG.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
...
GlobalVars["Population Subset", "Value"] <- "H"
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationH.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationH.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationH.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
...
GlobalVars["Population Subset", "Value"] <- "I"
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationI.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationI.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationI.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
...
GlobalVars["Population Subset", "Value"] <- "J"
...
resultsDE_zerobmidec <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_zerobmidec_populationJ.csv")
...
resultsDEW_zerobmidec <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_zerobmidec_populationJ.csv")

Table4_zerobmidec<-Summarize_results(resultsDE_zerobmidec,resultsDEW_zerobmidec)
write.csv(Table4_zerobmidec, "Results/Table 4 - Sensitivity Analysis/Test/Table4_zerobmidec_populationJ.csv")
rm(resultsDE_zerobmidec)
rm(resultsDEW_zerobmidec)
rm(Table4_zerobmidec)
rm(parameter_zerobmidec)
...
#################################################################################
#####################          No Calibration      ##############################
parameter_nocalibration<-parameter
parameter_nocalibration[1:4000,"CALIBRATION_RR_MI"]<-1
parameter_nocalibration[1:4000,"CALIBRATION_RR_STR"]<-1
...
start.time_nocalibration <- Sys.time()
resultsDE_nocalibration <- run_model(population_clean, 
                                  parameter_nocalibration, 
                                  50, 
                                  "DE", 
                                  GlobalVars,
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationA.csv")


resultsDEW_nocalibration <- run_model(population_clean, 
                                   parameter_nocalibration, 
                                   50, 
                                   "DEW", 
                                   GlobalVars,
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationA.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationA.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
...
resultsDE_nocalibration <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationB.csv")
...
resultsDEW_nocalibration <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationB.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationB.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
...
resultsDE_nocalibration <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationC.csv")
...
resultsDEW_nocalibration <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationC.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationC.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
...
resultsDE_nocalibration <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationD.csv")
...
resultsDEW_nocalibration <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationD.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationD.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
...
resultsDE_nocalibration <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationE.csv")
...
resultsDEW_nocalibration <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationE.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationE.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
...
resultsDE_nocalibration <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationF.csv")
...
resultsDEW_nocalibration <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationF.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationF.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
...
resultsDE_nocalibration <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationG.csv")
...
resultsDEW_nocalibration <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationG.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationG.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
...
resultsDE_nocalibration <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationH.csv")
...
resultsDEW_nocalibration <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationH.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationH.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
...
resultsDE_nocalibration <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationI.csv")
...
resultsDEW_nocalibration <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationI.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationI.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
...
resultsDE_nocalibration <- run_model(population_clean, 
                                  ...
                                  random_numbers,
                                  LifeTables)
write.csv(resultsDE_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDE_nocalibration_populationJ.csv")
...
resultsDEW_nocalibration <- run_model(population_clean, 
                                   ...
                                   random_numbers,
                                   LifeTables)
write.csv(resultsDEW_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/resultsDEW_nocalibration_populationJ.csv")

Table4_nocalibration<-Summarize_results(resultsDE_nocalibration,resultsDEW_nocalibration)
write.csv(Table4_nocalibration, "Results/Table 4 - Sensitivity Analysis/Test/Table4_nocalibration_populationJ.csv")
rm(resultsDE_nocalibration)
rm(resultsDEW_nocalibration)
rm(Table4_nocalibration)
rm(parameter_nocalibration)
...
resultsDE_Mixed_F2F <- run_model(population_clean, 
                                 ...
                                 random_numbers,
                                 LifeTables)
#write.csv(resultsDE_Mixed_F2F, "Results/BETA/resultsDE_Mixed_F2F_populationA-with BETA model 2.csv")
resultsBETA_Mixed_F2F <- run_model(population_clean, 
                      parameter, 
                      50, 
                      "GLOW_beta_diff", 
                      GlobalVars,
...
#write.csv(resultsBETA_Mixed_F2F, "Results/BETA/resultsDE_Mixed_F2F_populationA-with BETA model 2.csv")
resultsBETATREAT_Mixed_F2F <- run_model(population_clean, 
                                   parameter, 
                                   50, 
                                   "GLOW_beta_treat", 
                                   GlobalVars,
